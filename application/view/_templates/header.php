...
<!--   Eski navbar
    <nav class="navbar navbar-dark bg-inverse">
        ...
        <a class="navbar-brand" href="<?php echo URL; ?>home/exampleone">subpage</a>
        <a class="navbar-brand" href="<?php echo URL; ?>home/exampletwo">subpage 2</a>
        <a class="navbar-brand" href="<?php echo URL; ?>songs">songs</a>
    </nav>
-->
